package com.springrecipe.springrecipe.bootstrap;

import com.springrecipe.springrecipe.domain.*;
import com.springrecipe.springrecipe.repositories.CategoryRepository;
import com.springrecipe.springrecipe.repositories.RecipeRepository;
import com.springrecipe.springrecipe.repositories.UnitOfMeasureRepository;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.addingIngredient(new Ingredient("Kosher salt", new BigDecimal(".5"), teapoonUom));
        guacRecipe.addingIngredient(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), tableSpoonUom));
        ...
        guacRecipe.addingIngredient(new Ingredient("Cilantro", new BigDecimal(2), tableSpoonUom, guacRecipe));
        guacRecipe.addingIngredient(new Ingredient("freshly grated black pepper", new BigDecimal(2), dashUom, guacRecipe));
